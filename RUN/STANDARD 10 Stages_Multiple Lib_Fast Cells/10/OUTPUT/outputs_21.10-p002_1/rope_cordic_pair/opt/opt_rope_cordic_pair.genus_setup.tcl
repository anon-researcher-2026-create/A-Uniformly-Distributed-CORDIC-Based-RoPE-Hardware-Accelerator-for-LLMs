...
if {$_slk_ != "1212.7"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1212.7,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "4669"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 4669,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "2023"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 2023,  current net area: $_net_area_"
}
unset _net_area_
