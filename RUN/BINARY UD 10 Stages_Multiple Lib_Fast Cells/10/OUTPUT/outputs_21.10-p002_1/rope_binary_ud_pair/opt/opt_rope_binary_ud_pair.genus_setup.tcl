...
if {$_slk_ != "1499.3"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1499.3,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "3961"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 3961,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "1543"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 1543,  current net area: $_net_area_"
}
unset _net_area_
