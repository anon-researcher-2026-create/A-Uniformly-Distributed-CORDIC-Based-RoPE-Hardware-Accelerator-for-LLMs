...
if {$_slk_ != "1046.0"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1046.0,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "4025"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 4025,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "2008"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 2008,  current net area: $_net_area_"
}
unset _net_area_
