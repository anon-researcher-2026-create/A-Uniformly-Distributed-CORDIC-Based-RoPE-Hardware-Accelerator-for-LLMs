...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 04/22/2026 19:12:54
#
################################################################################
if { ![is_common_ui_mode] } { error "ERROR: This script requires common_ui to be active."}

read_mmmc OUTPUT/outputs_21.10-p002_1/rope_cordic_pair/opt/opt_rope_cordic_pair.mmmc.tcl
...
read_netlist OUTPUT/outputs_21.10-p002_1/rope_cordic_pair/opt/opt_rope_cordic_pair.v.gz
