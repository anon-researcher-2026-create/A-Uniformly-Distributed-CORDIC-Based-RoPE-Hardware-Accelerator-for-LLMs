...
source OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.flowkit_settings.tcl

source OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.invs_init.tcl

# Reading metrics file
################################################################################
read_metric -id current OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.metrics.json
## Reading Innovus Mode attributes file
pqos_eval {rcp::read_taf OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.mode_attributes.taf.gz}

## Reading common preserve file for dont_touch and dont_use preserve settings
source -quiet OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.preserve.tcl



# Mode Setup
################################################################################
source OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.mode
...
################################################################################
source -quiet OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.cell_pad.tcl 
...
################################################################################
      ...
      if { [is_attribute -obj_type port original_name] &&
        ...
        source OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.wnm_attrs.tcl
      }
    

# Reading NDR file
source OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.ndr.tcl

# Reading minimum routing layer data file
################################################################################
eval_legacy {gpsPrivate::readMinLayerCstr -file OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.min_layer} 
