...
#
# Init setup file
# Created by Genus(TM) Synthesis Solution on 04/27/2026 22:02:12
#
################################################################################
if { ![is_common_ui_mode] } { error "ERROR: This script requires common_ui to be active."}

read_mmmc OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.mmmc.tcl
...
read_netlist OUTPUT/outputs_21.10-p002_1/rope_binary_ud_pair/opt/opt_rope_binary_ud_pair.v.gz
