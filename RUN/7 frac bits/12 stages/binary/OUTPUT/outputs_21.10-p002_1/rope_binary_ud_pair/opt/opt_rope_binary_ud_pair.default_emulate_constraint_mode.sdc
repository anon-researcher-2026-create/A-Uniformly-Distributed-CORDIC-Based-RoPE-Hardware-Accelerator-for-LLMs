...
#  Created by Genus(TM) Synthesis Solution 21.10-p002_1 on Mon Apr 27 22:02:52 IST 2026
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {ud_bits[11]}]
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {ud_bits[10]}]
