...
if {$_slk_ != "1347.3"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack: 1347.3,  current slack: $_slk_"
}
unset _slk_
# multi-mode slack
# tns
...
if {$_cell_area_ != "2330"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 2330,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "1143"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 1143,  current net area: $_net_area_"
}
unset _net_area_
