...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {x_even[15]}]
...
set_input_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {x_odd[15]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {y_even[15]}]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.2 [get_ports {y_odd[15]}]
