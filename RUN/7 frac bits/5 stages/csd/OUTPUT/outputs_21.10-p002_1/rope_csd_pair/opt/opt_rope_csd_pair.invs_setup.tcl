...
source OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.flowkit_settings.tcl

source OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.invs_init.tcl
...
pqos_eval {rcp::read_taf OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.mode_attributes.taf.gz}

## Reading common preserve file for dont_touch and dont_use preserve settings
source -quiet OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.preserve.tcl



# Mode Setup
################################################################################
source OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.mode
...
################################################################################
source -quiet OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.cell_pad.tcl 
...
################################################################################
      ...
      if { [is_attribute -obj_type port original_name] &&
        ...
        source OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.wnm_attrs.tcl
      }
    

# Reading NDR file
source OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.ndr.tcl

# Reading minimum routing layer data file
################################################################################
eval_legacy {gpsPrivate::readMinLayerCstr -file OUTPUT/outputs_21.10-p002_1/rope_csd_pair/opt/opt_rope_csd_pair.min_layer} 
